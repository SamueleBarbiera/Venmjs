...
describe('venm init', () => {
    ...
    it('shows an appropriate warning if multiple arguments were provided with init', () => {
        ...
        expect(stderr).toContain('Error: Kindly provide only one argument as the directory name!!')
    })

    it('creates a new VENM stack webapp based on the Nuxt.js starter template', async () => {
